"""
(Read-only) File tree of all datasets in the database
...
__DATA_DIR = importlib.resources.files(_data_resources)
__root_key = str(__DATA_DIR.joinpath("parquet"))

FILE_TREE = MappingProxyType(
    {
        __root_key: {
            "geog": {
                "files": [
            ...
            "benefits": {
                ...
                "social_security": {
                    "files": ["ssdi.parquet", "ssi.parquet", "ssp.parquet"]
                },
                "childcare": {
                    "files": [
                        "ccdf_AK.parquet",
